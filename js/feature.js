      ...
      success: function twitchData(data) {
        ...
        if(data.stream !== null){
          ...
          //IF EVERYTHING IS A SUCCESS IT BUILDS A STREAMCARD//
            if (streamLogo !== null){
              streamCard = "<div class='online overlay'>" + "<a target='myiframe' href='https://player.twitch.tv/?channel="+twitchUserName+"'><div class='card cardList cardFeature'><span class='tag tag-success status-bar'>ONLINE</span>" + "<div class='card-block'>" + "<img class='round-logo img-responsive logo' src='" + streamLogo + "' alt='" + twitchUserName + "logo'>" + '<br>' + "<div class='text-padding'>" + "<h4 class='card-title'>" + twitchUserName.toUpperCase() + "</h4><p class='card-text'><strong>" + streamGame.toUpperCase() + ": </strong>" + streamInfo.toUpperCase() + "</p></a></div></div></div></div>";
              $(".card-container").append(streamCard);
            }else{
              streamCard = "<div class='online overlay'>" + "<a target='myiframe' href='https://player.twitch.tv/?channel="+twitchUserName+"'><div class='card cardList cardFeature'><span class='tag tag-success status-bar'>ONLINE</span>" + "<div class='card-block'>" + "<img class='round-logo img-responsive logo' src='" + defaultImage + "' alt='" + twitchUserName + "logo'>" + '<br>' + "<div class='text-padding'>" + "<h4 class='card-title'>" + twitchUserName.toUpperCase() + "</h4><p class='card-text'><strong>" + streamGame.toUpperCase() + ": </strong>" + streamInfo.toUpperCase() + "</p></a></div></div></div></div>";
              $(".card-container").append(streamCard);
            }
