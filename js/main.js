...
///////////////////////////////////////////////////
///////////////////////////////////////////////////
  var twitchUserName = ['MewtwoRaves','DarkAcreJack','sideshowmatt','blackdynamitetv','johanmoney','sblindside','vvarrentv',"thenutzxd",'jamaica105','michiganspartan','ritterriffic','stonertrixx'];
          ...
          $.ajax({
            ...
            success: function(data){
              ...
              if (streamError == 404 || streamBanner == null || streamLogo == null){
                $.ajax({
                  ...
                  success: function(data){
                    ...
                    if(streamMessage == "Unprocessable Entity"){
                      streamCard = "<div class='theCard offline col-xs-8 col-md-4 overlay'>" + "<a target='_blank' disabled class='card-link' href=" + streamURL + "><div class='card'>" + "<img class='img-fluid stream-cap' src='" + defaultImage + "' alt='" + twitchUserName + " image capture'><span class='tag tag-default status-bar'>OFFLINE</span>" + "<div class='card-block'>" + "<img class='round-logo img-responsive logo' src='" + defaultThumb + "' alt='" + twitchUserName + "logo'>" + '<br>' + "<div class='text-padding'>" + "<h4 class='card-title'>" + twitchUserName.toUpperCase() + "</h4><p class='card-text'>This Twitch account has been closed.</p></div></div></div></a></div>";
                      $(".card-container").append(streamCard);
                        ...
                        streamCard = "<div class='theCard offline col-xs-8 col-md-4 overlay'>" + "<a target='_blank' disabled class='card-link' href=" + streamURL + "><div class='card oro2'>" + "<img class='theCardIMG img-fluid stream-cap' src='" + defaultImage + "' alt='" + twitchUserName + " image capture'><iframe class='chat' src='https://www.twitch.tv/" + twitchUserName + "/chat?popout=' frameborder='0' scrolling='no'></iframe>" + "<br><span class='tag tag-default status-bar'>OFFLINE</span>" + "<div class='card-block'>" + "<img class='round-logo img-responsive logo' src='" + defaultThumb + "' alt='" + twitchUserName + "logo'>"+ '<br>' + "<div class='text-padding'>" + "<h4 class='card-title'>" + twitchUserName.toUpperCase() + "</h4><p class='card-text'>Not currently streaming.</p></div></div></div></a></div>";
                        $(".card-container").append(streamCard);
                    }
                ...
                streamCard = "<div class='theCard offline col-xs-8 col-md-4 overlay'>" + "<a target='_blank' disabled class='card-link' href=" + streamURL + "><div class='card'>" + "<img class='img-fluid stream-cap' src='" + streamBanner + "' alt='" + twitchUserName + " image capture'><iframe class='chat' src='https://www.twitch.tv/" + twitchUserName + "/chat?popout=' frameborder='0' scrolling='no'></iframe>" + "<br><span class='tag tag-default status-bar'>OFFLINE</span>" + "<div class='card-block'>" + "<img class='round-logo img-responsive logo' src='" + streamLogo + "' alt='" + twitchUserName + "logo'>"+ '<br>' + "<div class='text-padding'>" + "<h4 class='card-title'>" + twitchUserName.toUpperCase() + "</h4><p class='card-text'>Not currently streaming.</p></div></div></div></a></div>";
                $(".card-container").append(streamCard);
              }
            }
          })
